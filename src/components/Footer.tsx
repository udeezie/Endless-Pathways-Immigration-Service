    ...
    <footer className="footer">
      ...
      <div className="footer-social">
        <a
          ...
          className="footer-socialContainer containerOne"
          aria-label="Instagram"
        >
          <svg className="footer-socialSvg instagramSvg" viewBox="0 0 16 16">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="footer-socialContainer containerThree"
          aria-label="LinkedIn"
        >
          <svg className="footer-socialSvg linkdinSvg" viewBox="0 0 448 512">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="footer-socialContainer containerFour"
          aria-label="WhatsApp"
        >
          <svg className="footer-socialSvg whatsappSvg" viewBox="0 0 16 16">
